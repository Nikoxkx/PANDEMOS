...
export default function Landing({ onNavigate }: LandingProps) {
  ...
  return (
    <div>
      ...
      {/* Global Surveillance Map Preview */}
      <Section alt>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center max-w-[1100px] mx-auto">
          {/* Map Preview */}
          <div className="flex items-center justify-center">
            <div
              className="w-full max-w-[400px] aspect-[4/3] rounded-3xl overflow-hidden relative"
              style={{
                boxShadow: darkMode 
            ...
            >
              ...
              <div className="absolute inset-0">
                {[
                  { x: 25, y: 35, color: '#FF3B30', size: 10 },
                  { x: 55, y: 25, color: '#FF9500', size: 8 },
                  { x: 75, y: 45, color: '#FFCC00', size: 6 },
                  { x: 45, y: 55, color: '#FF3B30', size: 12 },
                  { x: 30, y: 50, color: '#FF9500', size: 7 },
                ].map((marker, i) => (
                  <div
                    key={i}
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 ${marker.size * 2}px ${marker.color}`,
              ...
              {/* Label */}
              <div
                className="absolute bottom-4 left-0 right-0 text-center text-[11px] uppercase tracking-[0.08em]"
          ...
          <div className="text-center md:text-center">
            ...
            <h2 className="text-[32px] md:text-[40px] font-semibold leading-[1.2] tracking-tight" style={{ color: textPrimary, letterSpacing: '-0.02em' }}>
              Every outbreak.<br />Mapped in real time.
            </h2>
            <p className="text-[17px] leading-[1.6] mt-5 max-w-[440px] mx-auto" style={{ color: textSecondary }}>
              Explore our interactive satellite map showing live outbreak data from 50+ health authorities. Click any marker for full source details and situation reports.
            </p>
            <button
              onClick={() => onNavigate('/war-room')}
